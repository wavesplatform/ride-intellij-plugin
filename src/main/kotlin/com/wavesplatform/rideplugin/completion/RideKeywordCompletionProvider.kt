...
class RideKeywordCompletionProvider(private val keywords: List<String>, private val addSpaceToEnd: Boolean) :
    ...
    override fun addCompletions(
        ...
        if (RideCompletionUtil.shouldComplete(parameters.position)) {

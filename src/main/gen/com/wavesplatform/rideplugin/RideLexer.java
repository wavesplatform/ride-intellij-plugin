 ...
 * from the specification file <tt>Ride.flex</tt>
 */
class RideLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return RideTypes.KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return RideTypes.COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return RideTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return RideTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 

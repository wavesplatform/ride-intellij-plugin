...
public class RideBlockStateImpl extends ASTWrapperPsiElement implements RideBlockState {

  public RideBlockStateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RideVisitor visitor) {
    visitor.visitBlockState(this);
  }
